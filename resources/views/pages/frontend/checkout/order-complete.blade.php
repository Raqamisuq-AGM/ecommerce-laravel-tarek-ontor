    ...
    <div class="page-content pt-7 pb-10 mb-10">
        ...
        <div class="container mt-8">
            ...
            <div class="order-results">
                ...
                <div class="overview-item">
                    <span>Email:</span>
                    <strong><a href="#" class="__cf_email__">example@gmail.com</a></strong>
                </div>
                <div class="overview-item">
                    <span>Total:</span>
            ...
            <div class="address-info pb-8 mb-6">
                ...
                <p class="email"><a href="#" class="__cf_email__">example@gmail.com</a></p>
            </div>
            <a href="{{route('product.all')}}" class="btn btn-icon-left btn-dark btn-back btn-rounded btn-md mb-4"><i
