...
<main class="main">
    <div class="page-content">
        ...
        <section class="intro-section">
            <div class="owl-carousel owl-theme row owl-dot-inner owl-dot-white intro-slider animation-slider cols-1 gutter-no"
                ...
                <div class="banner banner-fixed intro-slide1" style="background-color: #46b2e8;">
                    <figure>
                        <img src="{{asset('frontend/images/demos/demo1/slides/slide1.jpg')}}" alt="intro-banner"
                    ...
                    <div class="container">
                        <div class="banner-content y-50">
                            ...
                            <a href="{{route('product.all')}}" class="btn btn-dark btn-rounded slide-animate"
                ...
                <div class="banner banner-fixed intro-slide2" style="background-color: #dddee0;">
                    <figure>
                        <img src="{{asset('frontend/images/demos/demo1/slides/slide2.jpg')}}" alt="intro-banner"
                        ...
                        <div class="banner-content y-50 ml-auto text-right">
                            <h4 class="banner-subtitle ls-s mb-1 slide-animate"
                                data-animation-options="{'name': 'fadeInUp', 'duration': '.7s'}"><span
                                    ...
                                    class="font-weight-semi-bold ls-m">Poster Art Birthday</strong></h4>
                ...
                <div class="banner banner-fixed video-banner intro-slide3" style="background-color: #dddee0;">
                    <figure>
                        <video src="{{asset('frontend/video/memory-of-a-woman.mp4')}}" width="1903"
                            height="630"></video>
                    </figure>
                    <div class="container">
                        <div class="banner-content x-50 y-50 text-center">
                            ...
                            <p class="slide-animate mb-7 text-white ls-s font-primary "
                                ...
                                $199.00</p>
                            <a href="{{route('product.all')}}" class="btn btn-dark btn-rounded slide-animate mb-1"
        ...
        <!--001 Banner section End -->


        <!--002 Costomize secton start -->
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="banner banner-3 overlay-zoom banner-fixed banner-radius content-middle appear-animate"
                            ...
                            <div class="banner-content">
                                ...
                                <a href="{{route('product.all')}}" class="btn btn-white btn-link btn-underline">Shop
                                    Now<i class="d-icon-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-10">
                    ...
                    'responsive': {
                        ...
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset('frontend/images/demos/demo1/products/product5.jpg')}}"
                        ...
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset('frontend/images/demos/demo1/products/product6.jpg')}}"
                                        alt="Blue Pinafore Denim Dress" width="220" height="245"
                                        style="background-color: #f2f3f5;" />
                                </a>
                        ...
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset('frontend/images/demos/demo1/products/product7.jpg')}}"
                                        alt="Blue Pinafore Denim Dress" width="220" height="245"
                                        style="background-color: #f2f3f5;" />
                                </a>
                                <div class="product-action-vertical">
                        ...
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset('frontend/images/demos/demo1/products/product8.jpg')}}"
                                        alt="Blue Pinafore Denim Dress" width="220" height="245"
                                        style="background-color: #f2f3f5;" />
                                </a>
                                <div class="product-label-group">
                        ...
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset('frontend/images/demos/demo1/products/product9.jpg')}}"
                                        alt="Blue Pinafore Denim Dress" width="220" height="245"
                                        style="background-color: #f2f3f5;" />
                                </a>
                                <div class="product-label-group">
        ...
        <!--003 Tranding secton End -->

        <!--004 Set secton start -->
        <section class="product-wrapper mt-6 mt-md-10 pt-4 mb-10 pb-2 container appear-animate"
            data-animation-options="{'delay': '.6s'}">
            <div class="row">
                <div class="col-lg-2">
                    <h2 class="title title-center mb-5">Set</h2>
                </div>
                <div class="col-lg-10">
                    <div class="owl-carousel owl-theme row cols-2 cols-md-3 cols-lg-4 cols-xl-5" data-owl-options="{
                    'items': 5,
        ...
        <!--005 popular secton start -->
        <section class="product-wrapper mt-6 mt-md-10 pt-4 mb-10 pb-2 container appear-animate"
            data-animation-options="{'delay': '.6s'}">
            <div class="row">
                <div class="col-lg-2">
                    <h2 class="title title-center mb-5">Popular</h2>
                </div>
                <div class="col-lg-10">
                    <div class="owl-carousel owl-theme row cols-2 cols-md-3 cols-lg-4 cols-xl-5" data-owl-options="{
                    'items': 5,
        ...
        <!--005 popular secton End -->

        <!--006 best selling secton start -->
        <section class="product-wrapper mt-6 mt-md-10 pt-4 mb-10 pb-2 container appear-animate"
            data-animation-options="{'delay': '.6s'}">
            <div class="row">
                <div class="col-lg-2">
                    <h2 class="title title-center mb-5">Best Selling</h2>
                </div>
                <div class="col-lg-10">
                    <div class="owl-carousel owl-theme row cols-2 cols-md-3 cols-lg-4 cols-xl-5" data-owl-options="{
                    'items': 5,
        ...
        <!--006 best selling secton End -->

        <!--008 parallax secton start -->
        <section class="banner banner-background parallax text-center" data-option="{'offset': -60}"
            data-image-src="{{asset('frontend/images/demos/demo1/parallax.jpg')}}" style="background-color: #2d2f33;">
            <div class="container">
                ...
                <div class="owl-carousel owl-theme post-slider row cols-lg-3 cols-sm-2 cols-1" data-owl-options="{
                    ...
                    <div class="blog-post mb-4">
                        <article class="post post-frame overlay-zoom">
                            <figure class="post-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset('frontend/images/blog/frame/1.jpg')}}" alt="Blog post" width="340"
                                        height="206" style="background-color: #919fbc;" />
                                </a>
                            ...
                            <div class="post-details">
                                <h4 class="post-title"><a href="{{route('product.details',['slug'=>'1'])}}">Birthday Double Drop: new Jim
                                        Lee's X-Men posters
                                        Week</a></h4>
                                <p class="post-content">Lorem ipsum dolor sit amet,onadipiscing elit, sedsd
                                    doeiu smod tempo...</p>
                                <a href="{{route('product.details',['slug'=>'1'])}}" class="btn btn-primary btn-link btn-underline">Read
                    ...
                    <div class="blog-post mb-4">
                        <article class="post post-frame overlay-zoom">
                            <figure class="post-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset('frontend/images/blog/frame/2.jpg')}}" alt="Blog post" width="340"
                                        height="206" style="background-color: #e5e6e6;" />
                                </a>
                                <div class="post-calendar">
                                    <span class="post-day">19</span>
                                    <span class="post-month">JAN</span>
                    ...
                    <div class="blog-post mb-4">
                        <article class="post post-frame overlay-zoom">
                            <figure class="post-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset('frontend/images/blog/frame/3.jpg')}}" alt="Blog post" width="340"
                                        height="206" style="background-color: #eaeef1;" />
                                </a>
                                <div class="post-calendar">
                                    <span class="post-day">19</span>
                                    <span class="post-month">JAN</span>
                    ...
                    <div class="blog-post mb-4">
                        <article class="post post-frame overlay-zoom">
                            <figure class="post-media">
                                <a href="{{route('product.details',['slug'=>'1'])}}">
                                    <img src="{{asset(" frontend/images/blog/frame/3.jpg")}}" alt="Blog post"
        ...
        <!--009 Explor Poster secton End -->


        <!--010 Explor Quality secton start -->
        {{-- <section class="blog-post-wrapper mt-6 mt-md-10 pt-7 appear-animate"
            data-animation-options="{'name': 'fadeIn', 'duration': '1s'}">
            <div class="container">
                <h2 class="title title-center">Explor Poster Art</h2>
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                    ...
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product10.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Women’s Beautiful
                                                Headgear</a>
                                        </h3>
                                ...
                                <div class="product product-list-sm">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Hand Electric Cell</a>
                                        </h3>
                                        <div class="product-price">
                                ...
                                <div class="product product-list-sm">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Women Hempen Hood
                                                a Mourner</a>
                                        </h3>
                                        <div class="product-price">
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product13.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Fashionable Orginal
                                                Trucker</a>
                                        </h3>
                                        <div class="product-price">
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product14.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Men Summer Sneaker</a>
                                        </h3>
                                        <div class="product-price">
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product15.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Season Sports Cap</a>
                                        </h3>
                                        <div class="product-price">
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product16.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Blue Sports Shoes</a>
                                        </h3>
                                        <div class="product-price">
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product17.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Fashion Handbag</a>
                                        </h3>
                                        <div class="product-price">
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product18.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product19.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Fashion Electric Wrist
                                                Watch</a>
                                        </h3>
                                        <div class="product-price">
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product20.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Mackintosh Poket
                                                Backpack</a>
                                        </h3>
                                        <div class="product-price">
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/demos/demo1/products/product21.jpg')}}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a href="{{route('product.details',['slug'=>'1'])}}">Hempen Hood a
                                                Mourner
                                            </a>
                                        </h3>
                                        <div class="product-price">
