                ...
                <div class="col-md-6 sticky-sidebar-wrapper">
                    <div class="product-gallery pg-vertical sticky-sidebar" data-sticky-options="{'minWidth': 767}">
                        <div class="product-single-carousel owl-carousel owl-theme owl-nav-inner row cols-1 gutter-no">
                            <figure class="product-image product-slider-1">
                                <img class="product-image-1" src="{{asset('frontend/images/product/11111.avif')}}"
                                    alt="product thumbnail" width="150" height="169">
                                <img class="product-image-1"
                                    src="{{asset('frontend/images/product/frames/frames_black_wood_patterns_2.png')}}"
                                    alt="product thumbnail" width="150" height="169">
                                <img class="product-image-1"
                                    src="{{asset('frontend/images/product/frames/frames_graphites_2.png')}}"
                                    alt="product thumbnail" width="150" height="169">
                                <img src="{{asset('frontend/images/product/frames/font.png')}}"
                                    data-zoom-image="images/product/product-16-1.jpg" alt="Converse Training Shoes"
                                    width="800" height="900">
                            </figure>
                            <figure class="product-image product-slider-2">
                                <img src="{{asset('frontend/images/product/product-16-2-600x675.jpg')}}"
                                    data-zoom-image="{{asset('frontend/images/product/product-16-2.jpg')}}"
                                    alt="Converse Training Shoes" width="800" height="900">
                            </figure>
                            <figure class="product-image product-slider-3">
                                <img src="{{asset('frontend/images/product/product-16-3-600x675.jpg')}}"
                                    data-zoom-image="{{asset('frontend/images/product/product-16-3.jpg')}}"
                                    alt="Converse Training Shoes" width="800" height="900">
                            </figure>
                            <figure class="product-image product-slider-4">
                                <img src="{{asset('frontend/images/product/product-16-4-600x675.jpg')}}"
                                    data-zoom-image="{{asset('frontend/images/product/product-16-4.jpg')}}"
                                    alt="Converse Training Shoes" width="800" height="900">
                            </figure>
                        </div>
                        <div class="product-thumbs-wrap">
                            <div class="product-thumbs">
                                <div class="product-thumb active">
                                    <img src="{{asset('frontend/images/product/product-16-1-150x169.jpg')}}"
                                        alt="product thumbnail" width="150" height="169">
                                </div>
                                <div class="product-thumb">
                                    <img src="{{asset('frontend/images/product/product-16-2-150x169.jpg')}}"
                                        alt="product thumbnail" width="150" height="169">
                                </div>
                                <div class="product-thumb">
                                    <img src="{{asset('frontend/images/product/product-16-3-150x169.jpg')}}"
                                        alt="product thumbnail" width="150" height="169">
                                </div>
                                <div class="product-thumb">
                                    <img src="{{asset('frontend/images/product/product-16-4-150x169.jpg')}}"
                                        alt="product thumbnail" width="150" height="169">
                                </div>
                            </div>
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-form product-color">
                            ...
                            <div class="product-variations">
                                <a class="color" data-src="{{asset('frontend/images/demos/demo7/products/big1.jpg')}}"
                                    href="#" style="background-color: #c8c7ce"></a>
                                <a class="color" data-src="{{asset('frontend/images/demos/demo7/products/2.jpg')}}"
                                    href="#" style="background-color: #537548"></a>
                                <a class="color" data-src="{{asset('frontend/images/demos/demo7/products/3.jpg')}}"
                                    href="#" style="background-color: #484975"></a>
                                <a class="color" data-src="{{asset('frontend/images/demos/demo7/products/4.jpg')}}"
                                    href="#" style="background-color: #313131"></a>
                            </div>
                        </div>
                        <div class="product-form product-swatch">
                            <label>Image:</label>
                            <div class="product-variations">
                                <a class="swatch" data-src="{{asset('frontend/images/demos/demo7/products/big1.jpg')}}"
                                    href="#"
                                    style="background-image: url({{asset('frontend/images/product/product-16-shoes1.jpg')}}); background-color: #c8c7ce"></a>
                                <a class="swatch" data-src="{{asset('frontend/images/demos/demo7/products/2.jpg')}}"
                                    href="#"
                                    style="background-image: url({{asset('frontend/images/product/product-16-shoes2.jpg')}}); background-color: #c8c7ce"></a>
                            </div>
                        </div>
                ...
                <div class="tab-content">
                            ...
                            <div class="col-md-6 pl-md-6 pt-4 pt-md-0">
                                ...
                                <figure class="p-relative d-inline-block mb-2">
                                    <img src="{{asset('frontend/images/product/product.jpg')}}" width="559" height="370"
                                        alt="Product" />
                                    <a class="btn-play btn-iframe" href="{{asset('frontend/video/memory-of-a-woman.mp4')}}">
                    ...
                    <div class="tab-pane " id="product-tab-size-guide">
                        <figure class="size-image mt-4 mb-4">
                            <img src="{{asset('frontend/images/product/size_guide.png')}}" alt="Size Guide Image"
                                ...
                                <ul class="comments-list">
                                    <li>
                                        <div class="comment">
                                            <figure class="comment-media">
                                                <a href="#">
                                                    <img src="{{asset('frontend/images/blog/comments/1.jpg')}}"
                                                        alt="avatar">
                                                </a>
                                            </figure>
                                            <div class="comment-body">
                                                ...
                                                <div class="file-input-wrappers">
                                                    ...
                                                    <img class="btn-play btn-img pwsp"
                                                        src="{{asset('frontend/images/products/product3.jpg')}}"
                                                        width="280" height="315" alt="product" />
                                                    <a class="btn-play btn-iframe"
                                                        style="background-image: url({{asset('frontend/images/product/product.jpg')}});background-size: cover;"
                                                        href="{{asset('frontend/video/memory-of-a-woman.mp4')}}">
                                                        <i class="d-icon-play-solid"></i>
                                                    </a>
                                                </div>
                                    ...
                                    <li>
                                        <div class="comment">
                                            <figure class="comment-media">
                                                <a href="#">
                                                    <img src="{{asset('frontend/images/blog/comments/2.jpg')}}"
                                                        alt="avatar">
                                                </a>
                                            </figure>
                                            <div class="comment-body">
                                ...
                                <form action="#">
                                    ...
                                    <div class="review-medias">
                                        <div class="file-input form-control image-input"
                                            style="background-image: url({{asset('frontend/images/product/placeholder.png')}});">
                                        ...
                                        <div class="file-input form-control video-input"
                                            style="background-image: url({{asset('frontend/images/product/placeholder.pn')}}g);">
                ...
                <div class="owl-carousel owl-theme owl-nav-full row cols-2 cols-md-3 cols-lg-4" data-owl-options="{
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('frontend/images/product/featured1.jpg')}}" alt="product" width="280"
                                    height="315">
                            </a>
                            <div class="product-label-group">
                                <label class="product-label label-new">new</label>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('frontend/images/product/featured2.jpg')}}" alt="product" width="280"
                                    height="315">
                            </a>
                            <div class="product-label-group">
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('frontend/images/product/featured3.jpg')}}" alt="product" width="280"
                                    height="315">
                            </a>
                            <div class="product-action-vertical">
                                <a href="#" class="btn-product-icon btn-cart" data-toggle="modal"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('frontend/images/product/featured4.jpg')}}" alt="product" width="280"
                                    height="315">
                            </a>
                            <div class="product-action-vertical">
                                <a href="#" class="btn-product-icon btn-cart" data-toggle="modal"
