...
<main class="main cart">
    <div class="page-content pt-7 pb-10">
        <div class="step-by pr-4 pl-4">
            <h3 class="title title-simple title-step {{ request()->routeIs('cart.all') ? 'active' : '' }}"><a
                    href="{{route('cart.all')}}">1. Shopping Cart</a></h3>
            <h3 class="title title-simple title-step {{ request()->routeIs('checkout') ? 'active' : '' }}"><a
                    href="{{route('cart.all')}}"><a href="{{route('checkout')}}">2. Checkout</a></h3>
            <h3
                class="title title-simple title-step {{ request()->routeIs('checkout.order-complete') ? 'active' : '' }}">
                <a href="{{route('cart.all')}}"><a href="{{route('checkout.order-complete')}}">3. Order
                        Complete</a>
            </h3>
        </div>
                        ...
                        <tbody>
                            <tr>
                                <td class="product-thumbnail">
                                    <figure>
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/products/product18.jpg')}}" width="100"
                                ...
                                <td class="product-name">
                                    <div class="product-name-section">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">Converse Training Shoes</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <figure>
                                        <a href="{{route('product.details',['slug'=>'1'])}}">
                                            <img src="{{asset('frontend/images/products/product19.jpg')}}" width="100"
                                                height="100" alt="product">
                                        </a>
                                    </figure>
                                </td>
                                <td class="product-name">
                                    <div class="product-name-section">
                                        <a href="{{route('product.details',['slug'=>'1'])}}">Women Beautiful
                                            Headgear</a>
                                    </div>
                                </td>
                                <td class="product-subtotal">
