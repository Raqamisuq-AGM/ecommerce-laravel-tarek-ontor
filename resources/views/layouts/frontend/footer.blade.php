    ...
    <div class="container">
                    ...
                    <div class="widget widget-info">
                        ...
                        <ul class="widget-body">
                            ...
                            <li>
                                <label>Email:</label>
                                <a
                                    href="https://d-themes.com/cdn-cgi/l/email-protection#bed3dfd7d2feccd7d1dadb90ddd1d3"><span
                                        class="__cf_email__"
                                        data-cfemail="076a666e6b47756e6863622964686a">[email&#160;protected]</span></a>
                            </li>
                            <li>
                                <label>Address:</label>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-center">
                <p class="copyright">Developed By &copy; Tarek Ontor (2024)</p>
            </div>
