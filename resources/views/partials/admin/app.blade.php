...
<head>
    ...
    <script>
        window.templateCustomizer = new TemplateCustomizer({
            ...
            pathResolver: function(path) {
                var resolvedPaths = {
                    // Core stylesheets
                    "core.css": "{{ asset('admin/assets/css/core.css') }}",
                    "core-dark.css": "{{ asset('admin/assets/css/core-dark.css') }}",
  ...
  <body>
    ...
    <!-- BEGIN: Vendor JS-->
    <script
        src="{{ asset('admin/assets/vendor/libs/jquery/jquery.js') }}">
    </script>
    <script
        src="{{ asset('admin/assets/vendor/libs/popper/popper.js') }}">
    </script>
    <script src="{{ asset('admin/assets/vendor/js/bootstrap.js') }}">
    </script>
    <script
        src="{{ asset('admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}">
    </script>
    <script
        src="{{ asset('admin/assets/vendor/libs/hammer/hammer.js') }}">
    </script>
    <script
        src="{{ asset('admin/assets/vendor/libs/typeahead-js/typeahead.js') }}">
    </script>
